...
namespace InventoryExpress.WebComponent
{
    ...
    public sealed class ComponentMoreLedgerAccountDelete : ComponentControlDropdownItemLink
    {
        ...
        /// Konstruktor
        /// </summary>
        public ComponentMoreLedgerAccountDelete()
        {
        ...
        public override IHtmlNode Render(RenderContext context)
        {
            ...
            Modal = new PropertyModal(TypeModal.Formular, TypeModalSize.Default) { RedirectUri = context.Application.ContextPath.Append("ledgerAccounts") };
