...
namespace InventoryExpress.WebPage
{
    ...
    public sealed class PageCostCenterMedia : PageWebApp, IPageCostCenter
    {
        ...
        {
            Form.Tag.Value = CostCenter.Media?.Tag;
        }
        ...
        public override void Process(RenderContextWebApp context)
        {
            ...
            {
                Uri = CostCenter.Media != null ? new UriRelative(CostCenter.Media?.Uri) : context.Uri.Root.Append("/assets/img/inventoryexpress.svg"),
                Width = 400,
