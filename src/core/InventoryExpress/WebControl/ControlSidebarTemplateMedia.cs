...
namespace InventoryExpress.WebControl
{
    ...
    public sealed class ControlSidebarTemplateMedia : ControlLink, IComponent
    {
        /// <summary>
        /// Konstruktor
        /// </summary>
        public ControlSidebarTemplateMedia()
        {
        }
        ...
        public override IHtmlNode Render(RenderContext context)
        {
            ...
            var media = ViewModel.Instance.Media.Where(x => x.ID == (template != null ? template.MediaID : null)).FirstOrDefault();
