...
namespace InventoryExpress.Model.WebItems
{
    public class WebItemEntityInventory : WebItemEntityBaseTag
    {
        ...
        /// <summary>
        /// Returns or sets the comments.
        /// </summary>
        [JsonPropertyName("comments")]
        public IEnumerable<WebItemEntityComment> Comments { get; set; }
        ...
        /// <summary>
        /// Returns or sets the attachments.
        /// </summary>
        [JsonPropertyName("attachments")]
        public IEnumerable<WebItemEntityInventoryAttachment> Attachments { get; set; }

        /// <summary>
        /// Returns or sets the journal.
        /// </summary>
        [JsonPropertyName("jornal")]
        public IEnumerable<WebItemEntityJournal> Journal { get; set; }
        ...
        internal WebItemEntityInventory(Inventory inventory)
            : base(inventory)
        {
            Uri = ViewModel.GetUri(this);
            Image = ViewModel.GetMedia(inventory.MediaId).Uri;
