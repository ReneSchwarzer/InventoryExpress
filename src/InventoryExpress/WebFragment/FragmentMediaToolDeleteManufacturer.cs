...
namespace InventoryExpress.WebFragment
{
    ...
    public sealed class FragmentMediaToolDeleteManufacturer : FragmentMediaToolDelete
    {
        /// <summary>
        /// Constructor
        /// </summary>
        public FragmentMediaToolDeleteManufacturer()
        {
        }
        ...
        public override IHtmlNode Render(RenderContext context)
        {
            ...
            var disabled = manufacturer.Media?.Image == null;
            ...
            Uri = ComponentManager.SitemapManager.GetUri<PageMediaDelete>(new ParameterMediaId(manufacturer.Media?.Guid));
            Modal = new PropertyModal(TypeModal.Formular, TypeModalSize.Default)
            {
                RedirectUri = ComponentManager.SitemapManager.GetUri<PageManufacturerEdit>(guid)
            };
