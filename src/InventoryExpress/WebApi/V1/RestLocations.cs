...
namespace InventoryExpress.WebApi.V1
{
    ...
    [Module<Module>]
    public sealed class RestLocations : ResourceRestCrud<WebItemEntityLocation>
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        /// <param name="request">The request.</param>
        /// <returns>An enumeration of which json serializer can be serialized.</returns>
        public override IEnumerable<WebItemEntityLocation> GetData(IWqlStatement<WebItemEntityLocation> wql, Request request)
        {
