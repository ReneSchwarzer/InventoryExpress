...
{
    /// <summary>
    /// Eine Seite, die zur Verwaltung der Standorte eingesetzt wird
    /// </summary>
    public sealed partial class PageLocation : Page
    {
        /// <summary>
        /// Konstruktor
        /// </summary>
        ...
        {
            Frame.Navigate(typeof(PageLocationHelp), DataContext);
        }

        /// <summary>
        /// Wird aufgerufen, wenn ein neuer Standorte erstellt werden soll
        /// </summary>
        /// <param name="sender">Der Auslöser des Events</param>
        /// <param name="e">Die Eventparameter</param>
        private void OnNavigateToAddPage(object sender, RoutedEventArgs e)
        {
            Frame.Navigate(typeof(PageLocationItemEdit), null);
        }
        ...
        {
            Frame.Navigate(typeof(PageLocationItemEdit), e.ClickedItem);
        }
        ...
        {
            Frame.Navigate(typeof(PageLocationItemEdit), DataContext);
        }
    }
}
