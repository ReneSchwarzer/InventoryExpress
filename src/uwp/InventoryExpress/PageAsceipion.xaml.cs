...
{
    /// <summary>
    /// Eine Seite, die zur Verwaltung der Zuschreibungen eingesetzt wird
    /// </summary>
    public sealed partial class PageAscription : Page
    {
        /// <summary>
        /// Konstruktor
        /// </summary>
        public PageAscription()
        {
        ...
        /// <summary>
        /// Wird aufgerufen, wenn ein neuer Zuschreibungen erstellt werden soll
        /// </summary>
        ...
        {
            Frame.Navigate(typeof(PageAscriptionItemEdit), e.ClickedItem);
        }
