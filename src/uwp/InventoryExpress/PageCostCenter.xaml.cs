...
{
    /// <summary>
    /// Eine Seite, die zur Verwaltung der Kostenstellen eingesetzt wird
    /// </summary>
    public sealed partial class PageCostCenter : Page
    {
        /// <summary>
        /// Konstruktor
        /// </summary>
        ...
        {
            Frame.Navigate(typeof(PageCostCenterHelp), DataContext);
        }

        /// <summary>
        /// Wird aufgerufen, wenn ein neuer Kostenstellen erstellt werden soll
        /// </summary>
        /// <param name="sender">Der Auslöser des Events</param>
        /// <param name="e">Die Eventparameter</param>
        private void OnNavigateToAddPage(object sender, RoutedEventArgs e)
        {
            Frame.Navigate(typeof(PageCostCenterItemEdit), null);
        }
        ...
        {
            Frame.Navigate(typeof(PageCostCenterItemEdit), e.ClickedItem);
        }
        ...
        {
            Frame.Navigate(typeof(PageCostCenterItemEdit), DataContext);
        }
    }
}
