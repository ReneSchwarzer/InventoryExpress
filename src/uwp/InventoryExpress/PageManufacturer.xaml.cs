...
{
    /// <summary>
    /// Eine Seite, die zur Verwaltung der Hersteller eingesetzt wird
    /// </summary>
    public sealed partial class PageManufacturer : Page
    {
        /// <summary>
        /// Konstruktor
        /// </summary>
        ...
        {
            Frame.Navigate(typeof(PageManufacturerHelp), DataContext);
        }

        /// <summary>
        /// Wird aufgerufen, wenn ein neuer Hersteller erstellt werden soll
        /// </summary>
        /// <param name="sender">Der Auslöser des Events</param>
        /// <param name="e">Die Eventparameter</param>
        private void OnNavigateToAddPage(object sender, RoutedEventArgs e)
        {
            Frame.Navigate(typeof(PageManufacturerItemEdit), null);
        }
        ...
        {
            Frame.Navigate(typeof(PageManufacturerItemEdit), e.ClickedItem);
        }
        ...
        {
            Frame.Navigate(typeof(PageManufacturerItemEdit), DataContext);
        }
    }
}
