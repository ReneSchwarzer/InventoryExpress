...
{
    /// <summary>
    /// Eine Seite, die zur Verwaltung der Zustände eingesetzt wird
    /// </summary>
    public sealed partial class PageState : Page
    {
        /// <summary>
        /// Konstruktor
        /// </summary>
        ...
        {
            Frame.Navigate(typeof(PageStateHelp), DataContext);
        }

        /// <summary>
        /// Wird aufgerufen, wenn ein neuer Zustände erstellt werden soll
        /// </summary>
        /// <param name="sender">Der Auslöser des Events</param>
        /// <param name="e">Die Eventparameter</param>
        private void OnNavigateToAddPage(object sender, RoutedEventArgs e)
        {
            Frame.Navigate(typeof(PageStateItemEdit), null);
        }
        ...
        {
            Frame.Navigate(typeof(PageStateItemEdit), e.ClickedItem);
        }
        ...
        {
            Frame.Navigate(typeof(PageStateItemEdit), DataContext);
        }
    }
}
